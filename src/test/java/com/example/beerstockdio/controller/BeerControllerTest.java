package com.example.beerstockdio.controller;

import com.example.beerstockdio.builder.BeerDTOBuilder;
import com.example.beerstockdio.dto.BeerDTO;
import com.example.beerstockdio.dto.QuantityDTO;
import com.example.beerstockdio.exception.BeerNotFoundException;
import com.example.beerstockdio.exception.BeerStockExceededException;
import com.example.beerstockdio.service.BeerService;
...
import static com.example.beerstockdio.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.name", is(beerDTO.getName())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.brand", is(beerDTO.getBrand())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.type", is(beerDTO.getType().toString())));
    }
    ...
    void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].name", is(beerDTO.getName())))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].brand", is(beerDTO.getBrand())))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].type", is(beerDTO.getType().toString())));
    }
    ...
    void whenPATCHIsCalledToIncrementDiscountThenOKstatusIsReturned() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.patch(BEER_API_URL_PATH + "/" + VALID_BEER_ID + BEER_API_SUBPATH_INCREMENT_URL)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.brand", is(beerDTO.getBrand())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.type", is(beerDTO.getType().toString())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.quantity", is(beerDTO.getQuantity())));
    }
